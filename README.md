[![larsonscanner](https://i.griefed.de/images/2022/06/12/repo_and_website_banner.png)](https://github.com/Griefed/LarsonScanner)
...
[![GitHub Repo stars](https://img.shields.io/github/stars/Griefed/LarsonScanner?label=GitHub%20Stars&style=for-the-badge&logo=Github&labelColor=325358&color=c0ffee)](https://github.com/Griefed/LarsonScanner)
[![GitHub forks](https://img.shields.io/github/forks/Griefed/LarsonScanner?label=GitHub%20Forks&style=for-the-badge&logo=Github&labelColor=325358&color=c0ffee)](https://github.com/Griefed/LarsonScanner)
...
`$VERSION` is the version of LarsonScanner you want to use in your project. The most recent version as of me writing this is `1.0.3`, however, for newer versions, make sure to check out the [releases](https://github.com/Griefed/LarsonScanner/releases)-page. More information can be found at [Sonatype Maven](https://search.maven.org/artifact/de.griefed/larsonscanner)
...
![partitioning](misc/partitioning.gif)
...
![aspect_ratio](misc/aspect_ratio.gif)
...
![cylon_oval](misc/cylon_oval.gif)

#### Rectangle

![cylon_rectangle](misc/cylon_rectangle.gif)
...
![gradient_oval](misc/gradient_oval.gif)
...
![eye_colours](misc/eye_colours.gif)
...
![scanner_background](misc/scanner_background.gif)
...
![eye_background](misc/eye_background.gif)
...
![playground](misc/playground.png)
